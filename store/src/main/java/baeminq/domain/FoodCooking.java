...
import baeminq.StoreApplication;
import baeminq.domain.OrderDenied;
...
public class FoodCooking {
    ...
    public static void ordercopy(OrderPlaced orderPlaced) {
        /** Example 1:  new item 
    ...
    public static void statusUpdate(Paid paid) {
        /** Example 1:  new item 
        FoodCooking foodCooking = new FoodCooking();
        repository().save(foodCooking);
